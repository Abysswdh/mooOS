...
export default function LaporanPage() {
  ...
  const shuColumns: ColumnDef<ShuDistributionItem>[] = [
    ...
    { 
      header: "Kontribusi Susu (L)", 
      accessor: "total_milk_contribution_liters", 
      align: "right",
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 flex gap-3 text-blue-800">
          ...
          <div className="text-sm">
            ...
            <p>
              ...
              Porsi yang diterima oleh setiap anggota dihitung secara proporsional berdasarkan jumlah sapi yang mereka titipkan dan kontribusi susu yang dihasilkan. Semakin banyak sapi, semakin besar SHU yang diperoleh.
            </p>
          </div>
        </div>
