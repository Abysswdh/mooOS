    ...
    <div className="space-y-6 max-w-3xl">
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <Card className="border-blue-200 bg-blue-50/50">
          ...
          <CardContent>
            <div className="mb-4 bg-amber-50/50 border border-amber-200 rounded-md p-3 text-xs text-amber-800 leading-relaxed">
              <strong className="block mb-1 flex items-center gap-1">
                <AlertCircle className="w-3.5 h-3.5" /> Catatan Khusus Demo
              </strong>
              Arsitektur asli fitur ini akan menyebarkan polling ke <strong>Grup Komunitas Koperasi</strong>. Khusus untuk sesi presentasi ini, pesan sengaja diarahkan ke <strong>Personal Chat (DM)</strong> agar juri bisa langsung mencoba fitur tanpa harus repot mengatur grup baru dan izin Admin bot.
            </div>
            <Button 
